...
public class InfoFotoAlbumPerfilUsuario {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InfoFotoAlbumPerfilUsuario window = new InfoFotoAlbumPerfilUsuario(null);
	 ...
	 */
	public InfoFotoAlbumPerfilUsuario(Foto foto) {
		this.foto = foto;
		initialize();
	}
	...
	private void initialize() {
		...
		frameFotoAlbum.setBounds(100, 100, 570, 417);
		...
		JButton btnNewButton_3 = new JButton("Ver comentarios");
		...
		btnNewButton_3.setIcon(new ImageIcon(InfoFotoAlbumPerfilUsuario.class.getResource("/Imagenes/ojo-rojo.png")));
		panel_2.add(btnNewButton_3);
		
		JButton btnNewButton_2 = new JButton("Like");
		btnNewButton_2.setIcon(new ImageIcon(InfoFotoAlbumPerfilUsuario.class.getResource("/Imagenes/corazon.png")));
