...
public class InfoAlbumPerfilUsuario {

	private JFrame frameInfoAlbum;
	private AddPublicacionAlbum frameAddPublicacionAlbum;
	private InfoFotoAlbumPerfilUsuario frmInfoFotoAlbum;
	private Album album;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InfoAlbumPerfilUsuario window = new InfoAlbumPerfilUsuario(null);
	 ...
	 */
	public InfoAlbumPerfilUsuario(Album album) {
		this.album = album;
		initialize();
	}
	...
	private void initialize() {
		...
		btnNewButton_2.setIcon(new ImageIcon(InfoAlbumPerfilUsuario.class.getResource("/Imagenes/corazon.png")));
	...
	private void muestraInfoFotoAlbum(Foto foto) {
		if (frmInfoFotoAlbum == null)
			frmInfoFotoAlbum = new InfoFotoAlbumPerfilUsuario(foto);
