...
public class InfoFotoPerfilUsuario {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InfoFotoPerfilUsuario window = new InfoFotoPerfilUsuario(null);
	 ...
	 */
	public InfoFotoPerfilUsuario(Foto foto) {
		this.foto = foto;
		initialize();
	}
	...
	private void initialize() {
		...
		btnNewButton_3.setIcon(new ImageIcon(InfoFotoPerfilUsuario.class.getResource("/Imagenes/ojo-rojo.png")));
		panel_2.add(btnNewButton_3);

		btnNewButton_2.setIcon(new ImageIcon(InfoFotoPerfilUsuario.class.getResource("/Imagenes/corazon.png")));
